...
dbLoadRecords("$(TPG)/db/TPG300_base.db","P=$(DEVICE), PORT=L0,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),TPG_UNDERRANGE_ALARM_SEVERITY_A1=MINOR,TPG_UNDERRANGE_ALARM_SEVERITY_A2=MINOR,TPG_UNDERRANGE_ALARM_SEVERITY_B1=MINOR,TPG_UNDERRANGE_ALARM_SEVERITY_B2=MINOR")
dbLoadRecords("$(TPG)/db/TPG300_channels.db","P=$(DEVICE), PORT=L0,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),TPG_UNDERRANGE_ALARM_SEVERITY_A1=MINOR,TPG_UNDERRANGE_ALARM_SEVERITY_A2=MINOR,TPG_UNDERRANGE_ALARM_SEVERITY_B1=MINOR,TPG_UNDERRANGE_ALARM_SEVERITY_B2=MINOR")

# dbLoadRecords("$(TPG)/db/devTPG3xx.db","P=$(DEVICE), PORT=L0,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0)")

# dbLoadRecords("$(TPG)/db/TPG300_channels.db","P=$(DEVICE), PORT=L0,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0)")
